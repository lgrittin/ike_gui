...
{                                                                         
    ...
    //en protezione sovraccorrente AC,
    18,
    PROTECTION,
    uint,
...
{                                                                         
    ...
    1,
    1,
    &diagn_out.main_fsm_update_isr_cnt_ms,
    0,
    65535,

    //contatore isr freq_in_update,
    31,
    IGBT_OUTPUT,
    uint,
    ...
    1,
    1,
    &diagn_out.freq_in_update_isr_cnt_ms,
    0,
    65535,
